const circleDirections = ({ breath, inhale, exhale, pause }) => {
    ...
    switch (breath) {
        case 'ocean':
            ...
            circleName.style.animation = `ocean-breath ${totTime}s linear infinite`;
        ...
        case 'alternate':
            ...
            circleName.style.animation = `alt-breath ${totTime}s linear infinite`;
        ...
        case 'fire':
            ...
            circleName.style.animation = 'fire-breath 90s linear infinite';
            circleName.style.animationPlayState = 'paused';
            break;
        default:
            break;
